...
class EmailProcessorAgent(BaseAgent):
    ...
    async def process(self, state: AgentState) -> AgentState:
        ...
        try:
            ...
            Extract and structure key information from emails, including entities, actions, needs from sender, questions to answer, and urgency.
...
{{
    ...
    "context": {{
        ...
        "requested_information": ["list of specific information requested"],
        "requested_data": ["list of specific data requested"],
        "requested_dates": ["list of specific dates requested"],
